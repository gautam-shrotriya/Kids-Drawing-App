...
//                Toast.makeText(this@MainActivity, "Permission granted now you can read storage files.", Toast.LENGTH_SHORT).show()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val ibBrush: ImageButton = findViewById(R.id.ib_brush_button)
        ibBrush.setOnClickListener {
            showBrushSizeChooserDialog()
        }

        val ibGallery : ImageButton = findViewById(R.id.ib_gallery_button)
        ibGallery.setOnClickListener {
            requestStoragePermission()
        }

        val ibUndo: ImageButton = findViewById(R.id.ib_undo_button)
        ibUndo.setOnClickListener {
            drawingView?.onClickUndo()
        }

        val ibRedo: ImageButton = findViewById(R.id.ib_redo_button)
    ...
    private fun showBrushSizeChooserDialog(){
        ...
        brushDialog.setContentView(R.layout.dialog_box_brush_size)
